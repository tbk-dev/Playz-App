...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        private void SetscrollViewArea(Rect r)
        {
            ...
            Debug.Log(">>>> " + settingPanelHeight01);
            var buttomPanelHeight09 = height - settingPanelHeight01;
            var harfBtnPanelHeight = settingPanelHeight01 * 0.5f;
            Debug.Log(">>>> " + harfBtnPanelHeight);

            scrollView.position = new Vector3(Screen.safeArea.center.x, height - harfBtnPanelHeight, 0);
            //bottomBtnRect.sizeDelta = new Vector2(Screen.safeArea.width, settingPanelHeight01);
            scrollView.sizeDelta = new Vector2(r.width, settingPanelHeight01);
        }
        ...
        public void SetSettingMunuArea(Rect r)
        {
            ...
            var panelHeight08 = height * 0.8f;
            var panelHarfHeight = panelHeight01 * 0.5f;


            settingMenuRect.sizeDelta = new Vector2(Screen.safeArea.width, panelHeight08);
        ...
        private void SetBottomBTNArea(Rect r)
        {
            ...
            {
                Debug.LogError("bottomBtnRect == null");
                return;
            }
            var height = Screen.safeArea.height;
        ...
        //RectTransform ApplySafeArea(Rect r)
        void ApplySafeArea(Rect r)
        {
            ...
            if (Logging)
            {
                ...
                Debug.LogFormat("New Panel area applied to {0}: x={1}, y={2}, w={3}, h={4} on full extents w={5}, h={6}",
                name, Panel.rect.x, Panel.rect.y, Panel.rect.width, Panel.rect.height, Screen.width, Screen.height);
                Debug.LogWarning($"width :: { r.width == Panel.rect.width},      height :: {r.height == Panel.rect.height}");
            }
